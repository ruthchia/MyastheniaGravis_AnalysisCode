...
geom_point(aes(alpha = DIAGNOSIS), position = position_jitter()) +
scale_colour_manual(values = c("#E69F00", "#56B4E9")) +
scale_alpha_manual(guide='none', values = list(Control = 0.4, MG = 0.7)) +
scale_x_continuous(breaks = seq(-0.22,0.22,0.08), limits = c(-0.22,0.22)) +
scale_y_continuous(breaks = seq(-0.22,0.22,0.08), limits = c(-0.22,0.22)) +
theme_bw() +
